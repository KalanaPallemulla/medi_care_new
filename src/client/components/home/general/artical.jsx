                ...
                <div className="articles-info">
                  <div className="articles-left">
                    <Link to="/blog/blog-details">
                      <div className="articles-img">
                        <img src={blog_11} className="img-fluid" alt="" />
                      </div>
                    </Link>
                  </div>
                  <div className="articles-right">
                    <div className="articles-content">
                      ...
                      <h4>
                        <Link to="/blog/blog-details">
                          AMPLEXO – Making your clinic painless visit?
                        </Link>
                      </h4>
                      <p>
              ...
              <div className="articles-grid w-100">
                <div className="articles-info">
                  <div className="articles-left">
                    <Link to="/blog/blog-details">
                      <div className="articles-img">
                        <img src={blog_12} className="img-fluid" alt="" />
                      </div>
                    </Link>
                  </div>
                  <div className="articles-right">
              ...
              <div className="articles-grid w-100">
                <div className="articles-info">
                  <div className="articles-left">
                    <Link to="/blog/blog-details">
                      <div className="articles-img">
                        <img src={blog_13} className="img-fluid" alt="" />
                      </div>
                    </Link>
                  </div>
                  <div className="articles-right">
              ...
              <div className="articles-grid w-100">
                <div className="articles-info">
                  <div className="articles-left">
                    <Link to="/blog/blog-details">
                      <div className="articles-img">
                        <img src={blog_14} className="img-fluid" alt="" />
                      </div>
                    </Link>
                  </div>
                  <div className="articles-right">
